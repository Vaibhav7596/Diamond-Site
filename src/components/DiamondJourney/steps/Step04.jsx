...
import { Sparkles, Diamond, Droplets, Star } from 'lucide-react';
...
const Step04 = () => {
  const { t } = useLanguage();
  const stepData = t('diamondJourney.step4');
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_290px] gap-6 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <FeatureCard icon={Sparkles} title={stepData.card1Title} body={stepData.card1Body} />
          <FeatureCard icon={Diamond} title={stepData.card2Title} body={stepData.card2Body} />
          <FeatureCard icon={Droplets} title={stepData.card3Title} body={stepData.card3Body} />
          <FeatureCard icon={Star} title={stepData.card4Title} body={stepData.card4Body} />
        </div>
