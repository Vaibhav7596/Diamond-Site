...
import { Crosshair, Scissors, Layers, CheckCircle } from 'lucide-react';
...
const Step03 = () => {
  const { t } = useLanguage();
  const stepData = t('diamondJourney.step3');
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_290px] gap-6 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <FeatureCard icon={Crosshair} title={stepData.card1Title} body={stepData.card1Body} />
          <FeatureCard icon={Scissors} title={stepData.card2Title} body={stepData.card2Body} />
          <FeatureCard icon={Layers} title={stepData.card3Title} body={stepData.card3Body} />
